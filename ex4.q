...
/ regularized lrcost
rlrcost:{[l;X;y;theta]lrcost[X;y;theta]+(sum l%2*n*n:count y 0)*x$x:2 raze/ 1(_/:)'theta}
...
nncost:{[X;ymat;l;n;theta]
 ...
 if[l>0f;J+:(l%2*n)*{x$x}2 raze/ 1(_/:)'theta];
 d:x-ymat;
...
0.28762916516131876 = sum lrcost[X;ymat] (theta1;theta2)
