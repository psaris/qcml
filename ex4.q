...
.util.assert[0.28762916516131876] first .ml.nncostgrad[();n;hgolf;Y;X] theta
.util.assert[0.38376985909092381] first .ml.nncostgrad[.ml.l2[1f];n;hgolf;Y;X] theta
.util.assert[0.026047433852894011] sum last .ml.nncostgrad[();n;hgolf;Y;X] theta
.util.assert[0.0099559365856808548] sum last .ml.nncostgrad[.ml.l2[1f];n;hgolf;Y;X] theta

Y:.ml.diag[last[n]#1f]@\:"i"$y-1
-1 "computing the sum of each gradient";
sum each sum each g:.ml.nncut[n] last .ml.nncostgrad[.ml.l2[1f];n;hgolf;Y;X;theta]
