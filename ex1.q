...
.util.assert[32.072733877455654] .ml.lincost[();Y;X;THETA]
-1 "plot cost function of each gd step";
show .util.plt .ml.lincost[();X;Y] each 20 .ml.gd[alpha;.ml.lingrad[();Y;X]]\THETA
-1 "obtain optimal theta";
.ml.gd[alpha;.ml.lingrad[();Y;X]]/[THETA]
-1 "plot prediction of optimal theta";
show .util.plt X,.ml.gd[alpha;.ml.lingrad[();Y;X]]/[THETA]$.ml.prepend[1f] X
-1 "qml least squares";
...
4000 .ml.gd[alpha;.ml.lingrad[();Y;X]]/ THETA
